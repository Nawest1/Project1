...
def add_portfolio():
    ...
    if request.method == 'POST':
        ...
        portfolio = Portfolio(pname = portfolio_name)
...
def add_stock():
    ...
    for portfolio in portfolios:
        form.portfolio.choices.append((portfolio.id, portfolio.pname))
    if request.method == 'POST':
...
def delete(portfolio):
    portfolio = Portfolio.query.filter_by(pname=portfolio).first()
